...
def start(message):
    ...
    bot.reply_to(message, "Бот активирован. Доступные команды:\n"
                         "/add_morning - добавить утреннее сообщение\n"
                         "/add_news - добавить новость\n"
                         "/list_morning - список утренних сообщений\n"
                         "/list_news - список новостей\n"
                         "/delete_morning <номер> - удалить утреннее сообщение\n"
                         "/delete_news <номер> - удалить новость")
